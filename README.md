## Préambule
- Vous devez d'abord faire votre compte Github (possibilité d'utiliser votre compte microsoft)
...
⚠️ **SEULEMENT** les fichiers dans **assets/docs** doivent être modifiés !!!
...
- Les images doivent être mises dans **docs/assets/img** avec un nom **lisible**.
...
⚠️ **SURTOUT** Les fichiers en dehors de `assets/docs` NE DOIVENT PAS ÊTRE TOUCHÉ !!!!!!
...
⚠️ Il est possible qu'il y ait des "conflits", c'est à dire que sur le wiki, les fichiers sont trop différents pour être fusionné. Pas de panique, on vous expliquera pas à pas ce qu'il faudra faire dans ce cas là.
